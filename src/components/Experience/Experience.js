...
const experience_data = [
  ...
  },
  {
    ...
    details: [
      ...
      "Actively participated in code reviews and contributed to the establishment of coding standards, ensuring the quality and maintainability of software",
      "Worked on cross-browser compatibility issues and fixed bugs pertaining to various browsers",
      "Mentored and provided training to new immigrants, children, and underprivileged individuals in local communities, empowering them with programming skills",
